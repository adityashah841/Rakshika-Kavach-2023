...
class User {
  ...
  User(
      {required this.id, required this.username, required this.phone_number});
}
...
class Following{
  ...
  int volunteer;
  Following(
  {required this.volunteer, required this.warriors});
}
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          ...
          ElevatedButton(
            onPressed: () {
              _postAdd(myUser.phone_number); // Call the function to accept the request
              setState(() {
        ...
        child: ListTile(
          ...
          trailing: Row(
            ...
            children: [
              IconButton(
                onPressed: () {
                  _postAccept(item.id.toString()); // Call the function to accept the request
                  setState(() {
              ...
              IconButton(
                onPressed: () {
                  _postReject(item.id.toString()); // Call the function to accept the request
                  setState(() {
                    print("Button1 pressed");
                  });
                },
